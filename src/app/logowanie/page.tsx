...
import { GoogleAuthProvider, TwitterAuthProvider, createUserWithEmailAndPassword, signInWithEmailAndPassword, signInWithPopup } from 'firebase/auth';
...
export default function LoginPage() {
    ...
    return (
        <div className="flex justify-center gap-16 text-center flex-col md:flex-row">
            <div>
            ...
            <div>
                ...
                <Button variant="secondary" className="mt-4"><Link href="/reset-hasla">Reset hasła</Link></Button>
            </div>
